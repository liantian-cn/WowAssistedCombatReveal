...
0: Spell: 多重射击[id:257620]
    if talent '多重射击[id:257620]' is taken
    if player has resources to cast spell '多重射击[id:257620]'
    if spell '多重射击[id:257620]' is off cooldown
    if spell '多重射击[id:257620]' is within allowed range
    if player has buff/debuff '技巧射击[id:257622]' with at least 2000 ms left
...
1: Spell: 多重射击[id:257620]
    ...
    if spell '多重射击[id:257620]' is off cooldown
    if spell '多重射击[id:257620]' is within allowed range
    if player has buff/debuff '弹无虚发[id:260242]'
    if there are more than 3 targets within 10 yards of target
2: Spell: 急速射击[id:257044,cd:16]
    if talent '急速射击[id:257044,cd:16]' is taken
    if player has resources to cast spell '急速射击[id:257044,cd:16]'
    if spell '急速射击[id:257044,cd:16]' is off cooldown
    if spell '急速射击[id:257044,cd:16]' is within allowed range
（中间步骤略）
4: Spell: 瞄准射击[id:19434]
    if talent '瞄准射击[id:19434]' is taken
    if player has resources to cast spell '瞄准射击[id:19434]'
    if spell '瞄准射击[id:19434]' is off cooldown
    if spell '瞄准射击[id:19434]' is within allowed range
